# Chapter 2: Understanding Artificial Intelligence — Resources
...
## Note
This chapter is concept-based with no code examples. The code folder for this chapter is empty. Code starts from Chapter 3 where we make our first AI API call.
